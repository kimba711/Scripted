...
``
4. A new folder on the left should have appeared. Navigate to `curriculum/unitsYear2/7-dataMap/starter_code/`. You will work with three 3 files, specifically heatmap.js. 
